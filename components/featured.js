                            ...
                            <div class="uk-position-relative">
                                <div class="uk-slider-items uk-child-width-1-2 uk-child-width-1-4@m uk-grid-collapse" aria-live="polite" id="uk-slider-13" uk-grid>
                                    ...
                                    <div class="mk-slider-item uk-active" id="uk-slider-1" role="tabpanel" aria-label="1 of 8">
                                        <div class="mk-slider-image-wrapper mk-slider-image-large">
                                            <a class="uk-display-block" href="#item-one" uk-scroll>
                                                <img src="/img/featured/featured-02.jpg" class="mk-slider-image" width="750" height="500" alt="" class="uk-transition-opaque">
                                            </a>
                                        </div>
                                        <div class="overlay-hidden uk-transition-fade">
                                            <div class="uk-overlay uk-margin-remove-first-child">
                                                <div class="slide-item-title uk-margin-remove-bottom">Title One</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mk-slider-item" id="uk-slider-2" role="tabpanel" aria-label="2 of 8">
                                        <div class="mk-slider-image-wrapper mk-slider-image-small">
                                            <a class="uk-display-block" href="#item-two" uk-scroll>
                                                <img src="/img/featured/featured-01.jpg" class="mk-slider-image" width="750" height="500" alt="" class="uk-transition-opaque">
                                            </a>
                                        </div>
                                        <div class="overlay-hidden uk-transition-fade">
                                            <div class="uk-overlay uk-margin-remove-first-child">
                                                <div class="slide-item-title uk-margin-remove-bottom">Title Two</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mk-slider-item" id="uk-slider-3" role="tabpanel" aria-label="3 of 8">
                                        <div class="mk-slider-image-wrapper mk-slider-image-small">
                                            <a class="uk-display-block" href="#item-three" uk-scroll>
                                                <img src="/img/featured/featured-03.jpg" class="mk-slider-image" width="750" height="500" alt="" class="uk-transition-opaque">
                                            </a>
                                        </div>
                                        <div class="overlay-hidden uk-transition-fade">
                                            <div class="uk-overlay uk-margin-remove-first-child">
                                                <div class="slide-item-title uk-margin-remove-bottom">Title Three</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mk-slider-item" id="uk-slider-4" role="tabpanel" aria-label="4 of 8">
                                        <div class="mk-slider-image-wrapper mk-slider-image-small">
                                            <a class="uk-display-block" href="#item-four" uk-scroll>
                                                <img src="/img/featured/featured-04.jpg" class="mk-slider-image" width="750" height="500" alt="" class="uk-transition-opaque">
                                            </a>
                                        </div>
                                        <div class="overlay-hidden uk-transition-fade">
                                            <div class="uk-overlay uk-margin-remove-first-child">
                                                <div class="slide-item-title uk-margin-remove-bottom">Title Four</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mk-slider-item" id="uk-slider-6" role="tabpanel" aria-label="6 of 8">
                                        ...
                                        <div class="overlay-hidden uk-transition-fade">
                                            <div class="uk-overlay uk-margin-remove-first-child">
                                                <div class="slide-item-title uk-margin-remove-bottom">Title Five</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mk-slider-item" id="uk-slider-7" role="tabpanel" aria-label="7 of 8">
                                        ...
                                        <div class="overlay-hidden uk-transition-fade">
                                            <div class="uk-overlay uk-margin-remove-first-child">
                                                <div class="slide-item-title uk-margin-remove-bottom">Title Six</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mk-slider-item" id="uk-slider-8" role="tabpanel" aria-label="8 of 8">
                                        ...
                                        <div class="overlay-hidden uk-transition-fade">
                                            <div class="uk-overlay uk-margin-remove-first-child">
                                                <div class="slide-item-title uk-margin-remove-bottom">Title Seven</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>   
